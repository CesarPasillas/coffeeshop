package com.programmingsquirrel.coffeeshop.injection;

import com.programmingsquirrel.coffeeshop.injection.impl.MakeCoffeeAnotherImplementation;
import com.programmingsquirrel.coffeeshop.injection.impl.MakeCoffeeImplementation;
...
public class CoffeeshopApplication {
	...
	public static void main(String[] args) {
		...
		//Use the ApplicationContext to find which filter is begin used
		MakeCoffeeAnotherImplementation makeCoffeeAnother = appContext.getBean(MakeCoffeeAnotherImplementation.class);
		makeCoffeeAnother.prepareCoffe();
